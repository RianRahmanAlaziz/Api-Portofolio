...
@section('container')
    <form action="/dashboard/myproject/{{ $myproject->id }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                                ...
                                <div class="mt-5">
                                    <div
                                        ...
                                        <div class="w-32 mt-3 xl:mt-0 flex-1">
                                            <textarea name="description" id="description" rows="5" class="form-control">{{ old('description', $myproject->description) }}</textarea>
                                            @error('description')
                                                ...
                                                @if ($myproject->gambar)
                                                    <div
                                                        ...
                                                        <img class="rounded-md" alt="Preview Image"
                                                            src="/assets/images/{{ $myproject->gambar }}">
