                                ...
                                <div class="mt-5">
                                    <div
                                        ...
                                        <div class="w-32 mt-3 xl:mt-0 flex-1">
                                            <textarea name="description" id="description" rows="5" class="form-control">{{ old('description', $contact->description) }}</textarea>
                                            @error('description')
                                    ...
                                    <div
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <input id="email" name="email" type="email" class="form-control"
                                                value="{{ old('email', $contact->email) }}" placeholder="example@gmail.com">
                                            @error('email')
                                    ...
                                    <div
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <input id="github" name="github" type="text" class="form-control"
                                                value="{{ old('github', $contact->github) }}" placeholder="github">
                                            @error('github')
                                                <div class="text-danger mt-2">
                                                    {{ $message }}
                                                </div>
                                    ...
                                    <div
                                        ...
                                        <div class="w-full mt-3 xl:mt-0 flex-1">
                                            <input id="linkedin" name="linkedin" type="url" class="form-control"
                                                value="{{ old('linkedin', $contact->linkedin) }}" placeholder="linkedin">
                                            @error('linkedin')
                                                <div class="text-danger mt-2">
                                                    {{ $message }}
                                                </div>
                                                ...
                                                @if ($contact->gambar)
                                                    <div
                                                        ...
                                                        <img class="rounded-md" alt="Preview Image"
                                                            src="/assets/images/{{ $contact->gambar }}">
...
@push('script')
    ...
    `;
        ...
        function previewVideo(event) {
            const previewContainer = document.getElementById("preview-pdf");
