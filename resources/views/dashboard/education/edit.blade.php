...
@section('container')
    ...
    <div class="grid grid-cols-11 gap-x-6 mt-5 pb-20">
        <div class="intro-y col-span-11 2xl:col-span-9">
            <form action="/dashboard/education/{{ $education->id }}" method="post" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                ...
                <div class="intro-y box p-5 mt-5">
                    <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                        <div
                            ...
                            <i data-lucide="chevron-down" class="w-4 h-4 mr-2"></i> Education
                        </div>
                        <div class="mt-5">
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                <div class="form-label xl:w-64 xl:!mr-10">
                                    <div class="text-left">
                                        <div class="flex items-center">
                                            <div class="font-medium">Nama Universitas</div>
                                            <div
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="univ" name="univ" type="text" class="form-control"
                                        placeholder="Nama Universitas" value="{{ old('univ', $education->univ) }}">
                                    @error('univ')
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="jurusan" name="jurusan" type="text" class="form-control"
                                        placeholder="Jurusan" value="{{ old('jurusan', $education->jurusan) }}">
                                    @error('jurusan')
                                        <div class="text-danger form-help text-left">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-10">
                                ...
                                <div
                                    ...
                                    <div class="grid grid-cols-10 gap-5 pl-4 pr-5" id="preview-container0">
                                        ...
                                        @if ($education->gambar)
                                            @foreach (json_decode($education->gambar) as $index => $gambar)
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="from" name="from" type="text" data-single-mode="true"
                                        class="datepicker form-control" value="{{ old('from', $education->from) }}">
                                    @error('from')
                                        <div class="text-danger form-help text-left">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="to" name="to" type="text" data-single-mode="true"
                                        class="datepicker form-control" value="{{ old('to', $education->to) }}">
                                    @error('to')
                                        <div class="text-danger form-help text-left">
                                            {{ $message }}
                                        </div>
