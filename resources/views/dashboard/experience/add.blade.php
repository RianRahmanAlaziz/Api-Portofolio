...
@section('container')
    ...
    <div class="grid grid-cols-11 gap-x-6 mt-5 pb-20">
        <div class="intro-y col-span-11 2xl:col-span-9">
            <form action="/dashboard/experience" method="post" enctype="multipart/form-data">
                @csrf
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="title" name="title" type="text" class="form-control"
                                        placeholder="Nama Perusahaan" value="{{ old('title') }}">
                                    @error('title')
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <select id="pekerjaan" name="pekerjaan" class="form-select">
                                        ...
                                        <option value="Full Time" {{ old('pekerjaan') == 'Full Time' ? 'selected' : '' }}>
                                            Full Time</option>
                                        <option value="Part Time" {{ old('pekerjaan') == 'Part Time' ? 'selected' : '' }}>
                                            Part Time</option>
                                        <option value="Kontrak" {{ old('pekerjaan') == 'Kontrak' ? 'selected' : '' }}>
                                            Kontrak</option>
                                        <option value="Magang" {{ old('pekerjaan') == 'Magang' ? 'selected' : '' }}>Magang
                                        </option>
                                    </select>
                                    @error('pekerjaan')
                                        <div class="text-danger form-help text-left">
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="from" name="from" type="text" data-single-mode="true"
                                        class="datepicker form-control" value="{{ old('from') }}">
                                    @error('from')
                                        <div class="text-danger form-help text-left">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="to" name="to" type="text" data-single-mode="true"
                                        class="datepicker form-control" value="{{ old('to') }}">
                                    @error('to')
                                        <div class="text-danger form-help text-left">
                                            {{ $message }}
                                        </div>
